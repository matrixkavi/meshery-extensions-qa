...
(function() {
    ...
    // 1. Define the replacement logic
    function replaceFooter() {
        ...
        meshery-custom-end -->
          ...
          <!-- meshery-custom-end -->
            ...
            // Optional: If you only need to do this once, you can stop observing now.
            // observer.disconnect(); 
        }
    }
  ...
  function replaceMenuIcon() {
    ...
    const observer = new MutationObserver((mutations) => {
        // Every time the DOM changes, try to replace the footer
        replaceFooter();
        replaceMenuIcon();
    });
